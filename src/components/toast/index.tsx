...
const ToastStyleWrapper = styled.div`
  [data-sonner-toast] {
    font-weight: 600;
    font-size: 14px;
    ...
    &[data-type='info'] [data-action] {
      ...
      &:hover {
        background-color: ${rgbAlpha(
          themeVars.colors.palette.info.defaultChannel,
          0.08
        )};
      }
    }
    ...
    &[data-type='error'] [data-action] {
      ...
      &:hover {
        background-color: ${rgbAlpha(
          themeVars.colors.palette.error.defaultChannel,
          0.08
        )};
      }
    }
    ...
    &[data-type='success'] [data-action] {
      ...
      &:hover {
        background-color: ${rgbAlpha(
          themeVars.colors.palette.success.defaultChannel,
          0.08
        )};
      }
    }
    ...
    &[data-type='warning'] [data-action] {
      ...
      &:hover {
        background-color: ${rgbAlpha(
          themeVars.colors.palette.warning.defaultChannel,
          0.08
        )};
      }
    }
